      ...
      <div class="footer-brand">
        ...
        <div class="footer-socials">
          ...
          <a href="https://wa.me/919006666622" target="_blank" class="footer-social-btn" aria-label="WhatsApp">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.472 14.382c-.022-.08-.502-.243-.883-.436-.285-.104-1.834-.906-2.119-1.009-.285-.104-.492-.155-.7.155-.207.311-.803 1.01-.984 1.218-.181.207-.363.233-.673.078-1.164-.582-2.164-1.079-3.003-2.551-.208-.363.208-.337.802-1.526.104-.207.052-.389-.026-.544-.078-.155-.699-1.682-.957-2.304-.251-.605-.503-.523-.699-.533H8.7a.897.897 0 00-.647.306c-.285.31-1.087 1.062-1.087 2.59 0 1.528 1.113 3.004 1.268 3.21.155.207 2.19 3.344 5.308 4.69 2.082.898 2.76.767 3.251.646.559-.137 1.833-.751 2.092-1.476.259-.725.259-1.346.181-1.476-.077-.129-.284-.207-.594-.362zM12.015 1.792c-5.632 0-10.213 4.582-10.213 10.214 0 1.956.549 3.84 1.595 5.51L1.93 22.845l5.485-1.439a10.151 10.151 0 004.6 1.107h.004c5.631 0 10.214-4.58 10.214-10.214 0-2.73-1.062-5.297-2.993-7.228-1.93-1.93-4.502-2.993-7.227-2.993v-.286z" fill="currentColor"/>
            </svg>
          </a>
          <?php if ($yt = getSetting('youtube_url')): ?>
            <a href="<?= e($yt) ?>" target="_blank" class="footer-social-btn" aria-label="YouTube">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.582 6.186c-.23-.86-.908-1.538-1.768-1.768C18.254 4 12 4 12 4s-6.254 0-7.814.418c-.86.23-1.538.908-1.768 1.768C2 7.746 2 12 2 12s0 4.254.418 5.814c.23.86.908 1.538 1.768 1.768C5.746 20 12 20 12 20s6.254 0 7.814-.418c.86-.23 1.538-.908 1.768-1.768C22 16.254 22 12 22 12s0-4.254-.418-5.814zM10 15.464V8.536L16 12l-6 3.464z" fill="currentColor"/>
              </svg>
            </a>
          <?php endif; ?>
        </div>
