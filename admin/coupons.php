        ...
        <tbody>
          <?php foreach ($coupons as $c): ?>
            <tr>
              ...
              <td>
                <a href="coupons?delete=<?= $c['id'] ?>&csrf_token=<?= csrfToken() ?>" onclick="return confirm('Delete coupon?')" class="btn-admin btn-admin-danger btn-admin-sm" style="padding:6px;" title="Delete">
