          ...
          <tr>
            ...
            <td>
              <div style="display:flex; gap:6px;">
                <a href="product-edit?id=<?= $p['id'] ?>" class="btn-admin btn-admin-gold btn-admin-sm" style="padding:6px;" title="Edit">
                ...
                <a href="products?delete=<?= $p['id'] ?>&csrf_token=<?= csrfToken() ?>" onclick="return confirm('Delete this product?')" class="btn-admin btn-admin-danger btn-admin-sm" style="padding:6px;" title="Delete">
