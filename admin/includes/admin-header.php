  ...
  <aside class="admin-sidebar" id="adminSidebar">
    <div class="sidebar-brand-wrapper">
      <a href="index.php" class="brand" style="width: 100%; display: flex; justify-content: center;">
        <img src="<?= assetUrl('images/logoZ.png') ?>" alt="Logo">
      </a>
    ...
    <ul class="admin-menu">
      <li>
        <a href="index.php" class="<?= activeClass('index.php') ?>">
      ...
      <li>
        <a href="orders.php" class="<?= activeClass('orders.php') ?>">
      ...
      <li>
        <a href="products.php" class="<?= activeClass('products.php') ?>">
      ...
      <li>
        <a href="categories.php" class="<?= activeClass('categories.php') ?>">
      ...
      <li>
        <a href="coupons.php" class="<?= activeClass('coupons.php') ?>">
      ...
      <li>
        <a href="customers.php" class="<?= activeClass('customers.php') ?>">
      ...
      <li>
        <a href="import.php" class="<?= activeClass('import.php') ?>">
      ...
      <li>
        <a href="instagram.php" class="<?= activeClass('instagram.php') ?>">
      ...
      <li>
        <a href="homepage.php" class="<?= activeClass('homepage.php') ?>">
      ...
      <li>
        <a href="settings.php" class="<?= activeClass('settings.php') ?>">
      ...
      <li>
        <a href="change-password.php" class="<?= activeClass('change-password.php') ?>">
